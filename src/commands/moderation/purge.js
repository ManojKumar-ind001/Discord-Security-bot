...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    try {
      ...
      await interaction.editReply(V2.reply(V2.success('Purged',
        `Deleted **${del.size}** messages${user ? ` from **${user.tag}**` : ''}.`, client)));
    } catch (e) {
      await interaction.editReply(V2.reply(V2.error('Purge Failed', 'Cannot delete messages older than 14 days.', client)));
    }
  },
};
